...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "webank1234567890".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["35189147.xyz"];
pub const RS_PUB_KEY: &str = "bs8Mec6HmbJaNrh3tCqzyCJ1MVSEop+Pvboghef0ilg=";

pub const RENDEZVOUS_PORT: i32 = 9116;
pub const RELAY_PORT: i32 = 9117;
pub const WS_RENDEZVOUS_PORT: i32 = 9118;
pub const WS_RELAY_PORT: i32 = 9119;
